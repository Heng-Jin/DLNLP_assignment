...
train_data_path = pathlib.Path.cwd()/ "Kaggle_news_train_noisy60.csv"
...
model_save_path = parent_path / ("LSTM_train_noisy60_" + "epoch" + str(num_epochs) + "_lr" + str(learning_rate)  + str(time.strftime("_%m_%d_%H_%M", time.localtime())))
